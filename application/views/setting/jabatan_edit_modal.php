            ...
            <div class="modal-body">
                ...
                <div class="row small-list-margin">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <select id="bagian-edit-form" name="bagian" class="form-control" disabled required>
                ...
                <div class="row small-list-margin hide">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9">
                        <input type="text" name="edit-urut" class="form-control" value="0" maxlength="2" required>

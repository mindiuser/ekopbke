...
if(!empty($data)) {
    ...
    ?>
        <tr>
            ...
            <td><?php echo isset($row->BAGIAN)?$row->JABATAN:'';?></td>
            <td class="text-right">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        actionbutton += 'PILIH BAGIAN <span class="caret"></span></button>';
        actionbutton += '<ul class="dropdown-menu" role="menu">';
        actionbutton += '<li><a href="#">Tablet</a></li>';
        actionbutton += '<li><a href="#">Smartphone</a></li>';
        actionbutton += '</ul>';
        actionbutton += '</div>';
        actionbutton += '<button type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i><span style="padding-left:5px">Baru</span></button>';
        actionbutton += '';

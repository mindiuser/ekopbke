<div class="modal fade" id="edit-bukubesar-modal" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="bukubesar-edit-submit" class="btn btn-primary btn-sm">Simpan</button>
                <button type="button" id="bukubesar-edit-cancel" class="btn btn-danger btn-sm" data-dismiss="modal">Batal</button>
            </div>
        </div>
    </div>
</div>

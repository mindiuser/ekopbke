...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var initBar = function(){
            ...
            actionbutton += '<li><a href="#" class="select-kecamatan" id="<?php echo $row->ID_KEC;?>" label="<?php echo $row->NAMA_KECAMATAN;?>"><?php echo $row->NAMA_KECAMATAN;?></a></li>';
            <?php }} ?>
            actionbutton += '</ul>';
            actionbutton += '</div>';
